...
export default {
  data() {
    return {
      imgArr: [
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg1.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg2.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg3.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg4.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg5.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg6.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg7.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/SuZhou/bg8.png")
        },
        // {
  ...
  created(){
    ...
    this.$axios.fetchGet(`/weChatConfig`, { url: this.shareUrl }).then(res => {
      ...
      wx.ready(function() {
        let link =
          "https://fj.shangaofangjin.com/#/productDetail/suZhou?inventNum=" +
