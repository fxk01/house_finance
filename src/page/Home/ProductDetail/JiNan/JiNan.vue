...
export default {
  data() {
    return {
      imgArr: [
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg1.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg2.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg3.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg4.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg5.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg6.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg7.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/JiNan/bg8.png")
        },
        // {
  ...
  created(){
    ...
    this.$axios.fetchGet(`/weChatConfig`, { url: this.shareUrl }).then(res => {
      ...
      wx.ready(function() {
        let link =
          "https://fj.shangaofangjin.com/#/productDetail/jiNan?inventNum=" +
