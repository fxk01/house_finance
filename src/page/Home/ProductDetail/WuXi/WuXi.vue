...
export default {
  data() {
    return {
      imgArr: [
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg1.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg2.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg3.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg4.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg5.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg6.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg7.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuXi/bg8.png")
        },
        // {
  ...
  created(){
    ...
    this.$axios.fetchGet(`/weChatConfig`, { url: this.shareUrl }).then(res => {
      ...
      wx.ready(function() {
        let link =
          "https://fj.shangaofangjin.com/#/productDetail/wuXi?inventNum=" +
