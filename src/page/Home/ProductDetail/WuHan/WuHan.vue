...
export default {
  data() {
    return {
      imgArr: [
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg1.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg2.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg3.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg4.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg5.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg6.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg7.png")
        },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg8.png")
        },
        // {
        //   imgSrc: require("../../../../assets/img/home/WuHan/bg10.png")
        // },
        {
          imgSrc: require("../../../../assets/img/home/WuHan/bg9.png")
        }
      ],
  ...
  created(){
    ...
    this.$axios.fetchGet(`/weChatConfig`, { url: this.shareUrl }).then(res => {
      ...
      wx.ready(function() {
        let link =
          "https://fj.shangaofangjin.com/#/productDetail/wuHan?inventNum=" +
